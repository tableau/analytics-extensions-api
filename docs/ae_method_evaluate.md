...
Table Calculation Example: `curl -X POST http://localhost:9004/evaluate -d '{"data": {"arg_1": 1, "arg_2": 2}, "script": "return _arg1 + _arg2"}'`

Table Extension Example: `curl -X POST http://localhost:9004/evaluate -d '{"data": {"arg_1": {"Name": ["Bob", "Alice"], "Score": [1, 2]}, "script": "return _arg1"}'`
